...
```
manifest.json                  -- Manifest V3 configuration (v1.9.34.0, source of truth for version)
...
Full version history is maintained in the CHANGELOG.md file in the extension root. Format -- Keep a Changelog. Each release contains "Added", "Changed", "Fixed", "Removed" sections. Current version -- 1.9.34.0.
