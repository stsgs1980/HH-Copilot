...
| Size      | 56x56px, border-radius 18px                     |
...
| KPI cards (2x2 grid)  | Today's metrics              | Applications today (23), Invitations (5), Errors (1, with type 429 Rate limit), Total applications (147, +12% for the week)         |
...
| Block            | Function                | Details                                                                                                                              |
| ---------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Statistics (2x2) | Today's summary         | Applications, Invitations, Errors, Total applications                                                                                 |
...
| Element        | Description                                                                         |
| -------------- | ----------------------------------------------------------------------------------- |
| Logo           | "HC" icon (38x38px, green gradient) + "HH Copilot" text                            |
...
6 cards in a 3x2 grid with hover effects (elevation, rotation, cursor-following glow):
...
| KPI cards (2x2) | Sent today (127), Invitations (23), Replies (45), Awaiting reply (59)     |
...
| --------------- | --------- | --------- | ----------------- |
| Price           | 0 RUB/mo  | 990 RUB/mo | 2,990 RUB/mo     |
