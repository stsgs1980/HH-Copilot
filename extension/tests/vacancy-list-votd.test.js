...
import { parseVacanciesOfTheDay } from "../src/parsers/vacancy-list.js";
...
function createVotDBlock(opts = {}) {
  ...
  const clickUrl =
    opts.clickUrl ||
    `https://content.hh.ru/api/v1/vacancy_of_the_day/click?vacancyId=${vacancyId}&contentId=21001&domainAreaId=1`;
