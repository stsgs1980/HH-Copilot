...
const REAL_RESUME = {
  ...
  skills: [
    'B2B продажи', 'управление командой', 'переговоры',
    'работа с клиентами', 'CRM', 'аналитика продаж',
    'мотивация персонала', 'делегирование'
  ],
  derivedSkills: [
...
const ENRICHED_VACANCY = {
  ...SERP_VACANCY,
  keySkills: [
    'B2B продажи', 'переговоры', 'управление командой',
    'CRM', 'работа с клиентами', 'аналитика продаж',
    'мотивация персонала', 'делегирование', '1С', 'Power BI'
  ],
  derivedSkills: [
    'составление коммерческих предложений',
    'поиск новых клиентов'
  ],
  salary: { min: 200000, max: 300000, currency: 'RUR', gross: true, raw: 'от 200 000 до 300 000 руб. до вычета налогов' },
};
...
describe('REAL DATA: salary string edge cases', () => {
  ...
  it('salary {raw: "от 200 000", min: 200000, max: null} (from enrichment)', async () => {
    const r = scoreSalary(
      { salary: '200 000' },
      { salary: { raw: 'от 200 000', min: 200000, max: null } },
    );
