  ...
  experience: [
    {
      ...
      description: 'Leading frontend development for SaaS platform. Built component library, optimized bundle size by 40%, introduced TypeScript strict mode.',
    },
    {
      company: 'StartupXYZ',
      ...
      description: 'Developed customer-facing React application. Implemented CI/CD pipeline, wrote unit tests with Jest.',
    },
  ],
  salary: '200 000',
  address: 'Москва',
  ...
  describe('Edge cases', () => {
    it('should return 0 for null inputs', async () => {
      ...
      expect(result.breakdown).toEqual({
        skills: 0, title: 0, salary: 0, experience: 0, location: 0, semantic: 0,
      });
    });
