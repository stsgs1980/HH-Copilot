...
import { toggleZaiFields, bindProviderHandler, bindModelFetchHandler } from './ai-settings-handlers.js';

const DEBOUNCE_MS = 500;
const AI_FIELD_IDS = ['s-ai-provider', 's-ai-base-url', 's-ai-api-key', 's-ai-token', 's-ai-chat-id', 's-ai-user-id', 's-ai-model', 's-ai-timeout'];
...
export function readAiFields() {
  const sr = refs.shadowRoot;
  if (!sr) return { provider: 'zai', baseUrl: '', apiKey: '', token: '', chatId: '', userId: '', model: '', timeoutMs: 60000 };
