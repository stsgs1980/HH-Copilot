...
import { getAppliedVacancies, getBlacklistedCompanies } from "../lib/storage.js";
...
export async function loadAppliedAndBlacklisted() {
  try {
    const [appliedIds, blacklisted] = await Promise.all([getAppliedVacancies(), getBlacklistedCompanies()]);
