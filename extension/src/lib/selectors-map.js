 ...
 *
 * Extracted from selectors.js (AHG Rule 12).
 */
...
export const HH_SELECTORS = {
  ...
  resumeTitle: ['[data-qa="resume-block-title-position"]', 'h2[data-qa="resume-block-title-position"]'],
  resumeSalary: ['[data-qa="resume-block-salary"]', '[data-qa*="salary"]'],
  resumeSkillsTable: ['[data-qa="skills-table"]', '[data-qa*="skill"]'],
  resumeSkillTag: [".bloko-tag__text", '[data-qa="bloko-tag__text"]'],
  ...
  resumeListItem: ['[data-qa="resume-list-item"]'],
  resumeListTitle: ['[data-qa="resume-list-item-title"]', 'a[href*="/resume/"]'],
  resumeListLink: ['a[href*="/resume/"]'],
  ...
  negotiationsItem: [
    ...
    '[data-qa~="negotiations-item"]',
    '[class*="negotiations-item"]:not([class*="negotiations-item-"])',
  ],
  negotiationsItemCheckbox: [
    '[data-qa="negotiations-item-checkbox"]',
    'input[type="checkbox"][data-qa*="negotiations"]',
  ],
  negotiationsItemVacancy: [
    '[data-qa="negotiations-item-vacancy"]',
    '[data-qa^="negotiations-item-vacancy"]',
    '[class*="negotiations-item-vacancy"]',
  ],
  negotiationsItemCompany: [
    '[data-qa="negotiations-item-company"]',
    '[data-qa^="negotiations-item-company"]',
    '[class*="negotiations-item-company"]',
  ],
  negotiationsItemDate: [
    '[data-qa="negotiations-item-date"]',
    '[data-qa^="negotiations-item-date"]',
    '[class*="negotiations-item-date"]',
  ],
  negotiationsItemTag: [
    '[data-qa^="negotiations-tag"]',
    '[data-qa~="negotiations-tag"]',
    ".bloko-tag",
    '[class*="negotiations-tag"]',
  ],
  ...
  negotiationsEmployerStats: [
    ...
    '[data-qa^="negotiations-employer"]',
    '[class*="negotiations-employer"]',
  ],
  // -- Chatik (/chat) --
