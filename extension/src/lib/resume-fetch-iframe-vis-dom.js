 ...
 */
import { normalizeWs, VISIBILITY_HIDDEN, VISIBILITY_HIDDEN_DATA_QA, VISIBILITY_VISIBLE } from "./resume-constants.js";
...
export function checkHideLink(iframeDoc) {
  const hideLink = iframeDoc.querySelector(
    '[data-qa="resume-action-hide"], [data-qa*="resume-hide"], a[data-qa*="hide-resume"]',
  );
  if (hideLink) {
