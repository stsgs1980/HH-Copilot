...
import { CITY_ABBREVIATIONS, CITY_REGIONS } from "./location-city-data.js";
...
function identifyCity(locationText) {
  ...
  const sortedKeys = Object.keys(CITY_REGIONS)
    .filter((k) => k.length >= 3)
 ...
 */
export { detectWorkFormat, getRegion, identifyCity, normalizeLocation };
