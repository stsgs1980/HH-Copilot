...
import { renderMyResumesPanel, renderResumeListPanel, renderResumePanel } from "../ui/tabs/resumes.js";
...
async function loadFromResumePage(path) {
  ...
  if (hasUsefulData) {
    ...
    loadLog.warn(
      "Parse result has no useful data -- not saving. Found: " +
        JSON.stringify(resume._debug?.found) +
        " Missing: " +
