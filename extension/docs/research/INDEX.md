...
| 03 | [03-votd-irrelevant-vacancies.md](./03-votd-irrelevant-vacancies.md) | VOTD irrelevant vacancies — root cause, DOM analysis, code trace | 2026-06-15 | Research done, applied in v1.9.65.0 | `match-scorer-skills.js`, `vacancy-list.js`, `main-page-handlers-pages.js`, `vacancies.js` |
